...
| [#161](https://github.com/yusuke0610/etoki/pull/161) |        3 |      3 |        0 |      0 | web/CLAUDE.md のアクセシビリティ（入力欄の枠 3:1）と配色（一覧のボタンは折り返す）。長いボード名の省略は単発で還さず                                                                                   |
| [#162](https://github.com/yusuke0610/etoki/pull/162) |        5 |      4 |        1 |      0 | async-ui（組を移る行の state と、預けたものを捨てる時機）/ docs-consistency（取り下げの 1 件を「やらないこと」へ）。追加の 1 件（i2 の選択解除が作成後に戻る）は既存の test-effectiveness でカバー済み |
