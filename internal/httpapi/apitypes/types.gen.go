...
// Valid indicates whether the value is a known member of the AnnotationImageMediaType enum.
func (e AnnotationImageMediaType) Valid() bool {
	switch e {
	case AnnotationImageMediaTypeImagePng:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the DiagramKind enum.
func (e DiagramKind) Valid() bool {
	switch e {
	case DiagramKindArchitecture:
		return true
	case DiagramKindEr:
		return true
	case DiagramKindMindmap:
		return true
	case DiagramKindSequence:
		return true
	case DiagramKindTodo:
		return true
	default:
		return false
	}
...
func (e ErrorCode) Valid() bool {
	switch e {
	case ErrorCodeAlreadyMember:
		return true
	case ErrorCodeAuthNotConfigured:
		return true
	case ErrorCodeConcurrencyLimited:
		return true
	case ErrorCodeContentHashMismatch:
		return true
	case ErrorCodeCreationIncomplete:
		return true
	case ErrorCodeCrossSiteRejected:
		return true
	case ErrorCodeDiagramChatTooLong:
		return true
	case ErrorCodeDiagramFailed:
		return true
	case ErrorCodeForbiddenProject:
		return true
	case ErrorCodeForbiddenRole:
		return true
	case ErrorCodeGithubNotConfigured:
		return true
	case ErrorCodeGithubUnavailable:
		return true
	case ErrorCodeInternal:
		return true
	case ErrorCodeInterpretationFailed:
		return true
	...
	case ErrorCodeNotFound:
		return true
	case ErrorCodePreviousItemUnknown:
		return true
	...
	case ErrorCodeSceneTooLarge:
		return true
	case ErrorCodeSharingNotConfigured:
		return true
	case ErrorCodeTargetLocked:
		return true
	case ErrorCodeTargetMismatch:
		return true
	case ErrorCodeTargetNotSelected:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ProjectAccess enum.
func (e ProjectAccess) Valid() bool {
	switch e {
	case ProjectAccessAllowed:
		return true
	case ProjectAccessDenied:
		return true
	case ProjectAccessUnknown:
		return true
	default:
		return false
	}
...
func (e RunOutcome) Valid() bool {
	switch e {
	case RunOutcomeComplete:
		return true
	case RunOutcomeIncomplete:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SyncAction enum.
func (e SyncAction) Valid() bool {
	switch e {
...
// BoardDetail シーンと作成先の固定状態を加えたボード
